              ...
              {favoriteProducts.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {favoriteProducts.map((product) => (
                    <article
                      key={product.slug}
                      className="relative font-melon tracking-wide font-light rounded-2xl border-2 border-transparent p-4 transition-all duration-300 hover:border-[#F0E4A3]"
                    ...
                    >
                      ...
                      <Link href={`/product/${product.slug}`} className="block">
                        ...
                        <h3 className="mt-2 text-center text-[18px] uppercase leading-tight text-white">{product.name}</h3>
