            ...
            <div className="relative w-full flex justify-between items-center min-h-[280px] md:min-h-[320px]">
              ...
              <div>
                <button
                  ...
                  onClick={goPrev}
                  disabled={n <= 1}
                  className="collection-banner-prev cursor-pointer absolute left-[30%] lg:left-88 lg:right-0 -translate-y-1/2 -bottom-15 lg:top-2/5 z-10 w-9 h-9 border-2 border-primary rounded-full shadow flex items-center justify-center transition-transform duration-300 hover:scale-105 disabled:opacity-40 disabled:pointer-events-none"
                >
                ...
                <button
                  ...
                  onClick={goNext}
                  disabled={n <= 1}
                  className="collection-banner-next cursor-pointer absolute right-[30%] lg:right-0 -translate-y-1/2 -bottom-15 lg:top-1/2 z-10 w-9 h-9 border-2 border-primary rounded-full shadow flex items-center justify-center transition-transform duration-300 hover:scale-105 disabled:opacity-40 disabled:pointer-events-none"
                >
                  <svg className="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
