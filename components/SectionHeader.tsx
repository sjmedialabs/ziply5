...
export default function SectionHeader({ title, linkHref, linkText = "view all" }: SectionHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-4 mb-8 md:mb-12">
      <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#4A1D1F] tracking-wide text-center sm:text-left">
        {title}
      </h2>
      {linkHref && (
        <Link
