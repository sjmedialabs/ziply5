...
export default function AboutWhyChooseUsEditor({
  value = {},
  onChange,
}: {
  value: any;
      ...
      <CardContent className="px-4 py-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Uncompromised Quality"
            />
          </div>
          <div>
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="e.g. We hold ourselves to the highest global standards..."
          />
        </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g. Absolutely no cheap fillers..."
                  />
                </div>
              </div>
