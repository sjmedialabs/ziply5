...
export default function AboutRiceRangesEditor({
  value = {},
  onChange,
}: {
  value: any;
      ...
      <CardContent className="px-4 py-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Taste Varieties"
            />
          </div>
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Our Rice Ranges"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="e.g. Explore our carefully crafted ranges. From rich, vegetable-loaded..."
          />
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="e.g. Veg or Non-Veg"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  placeholder="e.g. Rice range packs"
                />
              </div>
            </div>
          )}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Explore Ranges"
            />
          </div>
          <div>
